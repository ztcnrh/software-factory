...
Follow the preloaded `factory-code-review` skill — it is your station contract. Judge the diff against the spec's acceptance criteria and the repo's bar: correctness, scope discipline, tests, security/data safety, fit, spec currency. Check `.factory/interventions/` for what reviewers here have cared about before.
