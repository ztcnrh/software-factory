...
- Existing product docs, if the repo has them (a roadmap, a vision note, a direction file): anchor the spec's direction to them, and flag divergence explicitly rather than drifting off-direction in silence — a divergence you can name is a decision for the reviewer; one you can't is drift.
