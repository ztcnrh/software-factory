...
The APIs, schemas, types, or events this introduces or alters.

## Alternatives considered
- **<alternative>** — why not (the reason matters more than the list).

## Risks & mitigations
Failure modes, blast radius, and how each is contained.
