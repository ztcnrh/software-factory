...
>
> The driver saves the rendered packet to `.factory/work-items/<id>/packet-<gate>-<n>.md` and binds it — `factory gate <id> --open --packet <file>` — before presenting, so the decision below is checked against exactly this content and refused if any of it changes first.
